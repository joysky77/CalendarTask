...
class EventsHelper(val context: Context) {
    ...
    fun getEventsSync(
        ...
        events.forEach {
            ...
            val originalEvent = it.id?.let { eventsDB.getEventWithId(it) }
    ...
    fun updateIsTaskCompleted(event: Event) {
        ...
        val task = completedTasksDB.getTaskWithIdAndTs(eventId, startTs = event.startTS)
