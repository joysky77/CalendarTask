...
//                !resources.getBoolean(org.fossify.commons.R.bool.hide_google_relations)
            findItem(R.id.toggle_sub_items).apply {
                ...
                setIcon(iconRes)
                title = getString(if (config.showSubItems) R.string.hide_sub_items else R.string.show_sub_items)
            }
        }
    }
    ...
    private fun toggleSubItems() {
        config.showSubItems = !config.showSubItems
        refreshMenuItems()
        refreshViewPager()
    }
